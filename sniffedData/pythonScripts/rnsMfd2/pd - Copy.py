...
class Decoder(srd.Decoder):
    ...
    def decode(self, *args):
        ...
        while True:
            if dataStartSampleIndex is None:
                dataStartSampleIndex = self.samplenum
    ...
    def _waitForStartCondition(self, startCondSampleIndex):
        ...
        """
        if startCondSampleIndex is None:  # startCondSampleIndex could be already discovered in previous STOP state
